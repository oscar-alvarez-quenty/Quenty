...
resource "aws_ecr_repository" "nginx" {
  ...
  tags = merge(var.tags, {
    Name = "${var.name_prefix}-nginx-ecr"
  })
}
...
# Lifecycle policy for nginx repository
...
# Repository policy for app (allow access from ECS)
